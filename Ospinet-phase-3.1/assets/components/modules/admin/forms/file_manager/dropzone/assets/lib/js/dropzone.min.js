        ...
        ! function () {
            ...
            d = "undefined" != typeof Emitter && null !== Emitter ? Emitter : b("emitter"), g = function () {}, a = function (a) {
                ...
                return j(b, a), b.prototype.events = ["drop", "dragstart", "dragend", "dragenter", "dragover", "dragleave", "selectedfiles", "addedfile", "removedfile", "thumbnail", "error", "errormultiple", "processing", "processingmultiple", "uploadprogress", "totaluploadprogress", "sending", "sendingmultiple", "success", "successmultiple", "canceled", "canceledmultiple", "complete", "completemultiple", "reset", "maxfilesexceeded"], b.prototype.defaultOptions = {
                    ...
                    dictDefaultMessage: "upload the file/Image",
                    ...
                    error: function (a, b) {
						//$("#upload_err_msg").html("upload fail");
                    ...
                    totaluploadprogress: function (a, b) {
                    	if(document.querySelector("#total-progress") == null)
                    		{
                    		document.querySelector("#total-progress-add").style.display = "block";
                			document.querySelector("#total-progress-add .progress-bar").style.width = a + "%";
                    		}
                    	else
                    		{
                    		document.querySelector("#total-progress").style.display = "block";
                        	document.querySelector("#total-progress .progress-bar").style.width = a + "%";
                    		}
                    	
                    	
                    	if(document.querySelector("#total-progress-add") == null)
	                		{
	                    		document.querySelector("#total-progress").style.display = "block";
	                        	document.querySelector("#total-progress .progress-bar").style.width = a + "%";
	                		}
                    	...
                    	if(a==100)
                    		{	
                    			setTimeout(function(){
                    				if(document.querySelector("#total-progress") == null)
	                            		{
	        	                    		document.querySelector("#total-progress-add").style.display = "none";
	                            		}
                    				else
	                    				{
	                    		...
	                    		$("#me").addClass("savereports").html('<i class="fa fa-check-circle"></i> Save');
	   						 	$("#new_report").addClass("savereportsnew").html('<i class="fa fa-check-circle"></i> Save');},1000);
                    		}
                    },
                    sending: g,
                    sendingmultiple: g,
                    success: function (a) {
                    	 $(".upload_err_msg").addClass("has-error").html("");
                    	 $(".upload_err_msg").addClass("success_color");
                    	 $(".upload_err_msg").removeClass("has-error");
