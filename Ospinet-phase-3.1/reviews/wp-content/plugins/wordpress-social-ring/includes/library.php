...
.social-ring-button {
	...
	<?
	php
	if($this->options['button_counter']
	==
	'vertical')
	{
	?>
...
<div id="fb-root"></div>
<script
	src="http://connect.facebook.net/<?php echo $this->options['facebook_language']; ?>/all.js#xfbml=1"></script>
...
<script
	type="text/javascript" src="http://assets.pinterest.com/js/pinit.js"></script>
<script type="text/javascript">
		(function() {
