...
<?php screen_icon('plugins'); ?>
	<h2>
	<?php _e('Social Network Settings',WP_SOCIAL_RING); ?>
	</h2>
		...
		<div class="postbox-container" style="width: 70%;">
			<form action="options.php" method="post">
				...
				<input name="submit" class="button-primary" type="submit"
					value="<?php _e('Save Changes',WP_SOCIAL_RING); ?>" />
			</form>
		</div>
		<div class="postbox-container" style="margin-left: 15px;">
			<div class="postbox">
				<h3>
				<?php _e('Help', WP_SOCIAL_RING); ?>
				</h3>
				<ul style="list-style: circle; padding: 10px 0 10px 30px;">
					<li><a target="_blank"
						href="http://wordpress.altervista.org/wordpress-social-ring/faq/">FAQ</a>
					</li>
					<li><a target="_blank"
						href="http://wordpress.org/support/plugin/wordpress-social-ring">Forum</a>
					</li>
				</ul>
			</div>
			<div class="postbox">
				<h3>
				<?php _e('News', WP_SOCIAL_RING); ?>
				</h3>
				<ul style="list-style: circle; padding: 10px 0 10px 30px;">
					<li><a target="_blank"
						href="http://wordpress.altervista.org/wordpress-social-ring-1-2-2/">WordPress
							Social Ring 1.2.2</a></li>
					<li><a target="_blank"
						href="http://wordpress.altervista.org/wp-social-ring-1-2-0/">WordPress
							Social Ring 1.2.0</a></li>
					<li><a target="_blank"
						href="http://wordpress.altervista.org/wordpress-social-ring-1-1-9/">WordPress
							Social Ring 1.1.9</a></li>
					<li><a target="_blank"
						href="http://wordpress.altervista.org/wordpress-social-ring-1-1-2-shortcode/">WordPress
							Social Ring 1.1.2</a></li>
					<li><a target="_blank"
						href="http://wordpress.altervista.org/wordpress-social-ring-1-1-template-tag-and-social-widget/">WordPress
							Social Ring 1.1.1</a></li>
				</ul>
			</div>
			<?php if(strpos($_SERVER['HTTP_HOST'], 'altervista') == false && strpos($_SERVER['HTTP_HOST'], 'giallozafferano') == false) { ?>
			<div class="postbox"
				style="min-width: 180px !important; margin-top: 5px; text-align: center; padding: 8px 0;">
			...
			<div style="text-align: center">
				<a target="_blank"
					href="<?php _e('http://en.altervista.org/create-free-blog.html?ref=socialring',WP_SOCIAL_RING); ?>">
					<img alt="<?php _e('Create your free blog!');?>"
					title="<?php _e('Create your free blog!');?>"
					src="http://im.altervista.org/wordpress/images/promo.gif"
					height="300" width="180" /> </a>
			</div>
			<?php } ?>
		</div>
			...
			function settings_description() {
				?>
<div class="explain">
<?php _e('Choose sharing buttons position and behavior', WP_SOCIAL_RING); ?>
</div>
<?php
			}
			...
			function counter_setting() {
				?>
<span> <input id="horizontal" type="radio"
	name="wp_social_ring_options[button_counter]" value="horizontal"
	<?php checked($this->options['button_counter'], 'horizontal') ?> /> <label
	for="horizontal"><?php _e('Horizontal', WP_SOCIAL_RING); ?> </label> </span>
<span style="padding-left: 30px;"> <input id="vertical" type="radio"
	name="wp_social_ring_options[button_counter]" value="vertical"
	<?php checked($this->options['button_counter'], 'vertical') ?> /> <label
	for="vertical"><?php _e('Vertical', WP_SOCIAL_RING); ?> </label> </span>
<span style="padding-left: 30px;"> <input id="none" type="radio"
	name="wp_social_ring_options[button_counter]" value="none"
	<?php checked($this->options['button_counter'], 'none') ?> /> <label
	for="none"><?php _e('None', WP_SOCIAL_RING); ?> </label> </span>
	<?php
			}
			...
			function position_setting() {
				?>
<ul>
	<li><span><input id='social_before_content'
			name='wp_social_ring_options[social_before_content]' type='checkbox'
			value="1"
			<?php if($this->options['social_before_content'] == 1) echo "checked"; ?> />
	</span> <span><?php _e('Before content',WP_SOCIAL_RING) ?> </span>
	</li>
	<li><span><input id='social_after_content'
			name='wp_social_ring_options[social_after_content]' type='checkbox'
			value="1"
			<?php if($this->options['social_after_content'] == 1) echo "checked"; ?> />
	</span> <span><?php _e('After content',WP_SOCIAL_RING) ?> </span>
	</li>
</ul>
			<?php
			}
...
<ul>
	<li style="clear: both;">
		<div style="float: left;">
			<input id='social_facebook_like_button'
				name='wp_social_ring_options[social_facebook_like_button]'
				type='checkbox' value="1"
				<?php checked($this->options['social_facebook_like_button'], 1); ?> />
		</div>
		<div style="float: left; margin-left: 20px; width: 150px;">
		<?php _e('Facebook Like',WP_SOCIAL_RING) ?>
		</div>
		<div style="float: left; margin-left: 20px;">
			<fb:like
				href="http://www.facebook.com/pages/DrWordPress/166397626712895"
				send="false" showfaces="false" width="108" layout="button_count"
				action="like" />
			</fb:like>
		</div>
	</li>
	<li style="clear: both; padding-top: 10px;">
		<div style="float: left;">
			<input id='social_facebook_send_button'
				name='wp_social_ring_options[social_facebook_send_button]'
				type='checkbox' value="1"
				<?php checked($this->options['social_facebook_send_button'], 1); ?> />
		</div>
		<div style="float: left; margin-left: 20px; width: 150px;">
		<?php _e('Facebook Send',WP_SOCIAL_RING) ?>
		</div>
		<div style="float: left; margin-left: 20px;">
			<fb:like
				href="http://www.facebook.com/pages/DrWordPress/166397626712895"
				send="true" showfaces="false" width="164" layout="button_count"
				action="like" />
			</fb:like>
		</div>
		<div id="fb-root"></div>
	...
	<li style="clear: both; padding-top: 10px;">
		<div style="float: left;">
			<input id='social_facebook_share_button'
				name='wp_social_ring_options[social_facebook_share_button]'
				type='checkbox' value="1"
				<?php checked($this->options['social_facebook_share_button'], 1); ?> />
		</div>
		<div style="float: left; margin-left: 20px; width: 150px;">
		<?php _e('Facebook Share',WP_SOCIAL_RING) ?>
		</div>
		<div style="float: left; margin-left: 20px;">
			<fb:share-button expr:href="http://wordpress.altervista.org/"
				width="140" type="button_count">
				</fb:share>
	...
	<li style="clear: both; padding-top: 10px;">
		<div style="float: left;">
			<input id='social_twitter_button'
				name='wp_social_ring_options[social_twitter_button]' type='checkbox'
				value="1"
				<?php checked($this->options['social_twitter_button'], 1); ?> />
		</div>
		<div style="float: left; margin-left: 20px; width: 150px;">
		<?php _e('Twitter',WP_SOCIAL_RING) ?>
		</div>
		<div style="float: left; margin-left: 20px;">
			<a href="http://twitter.com/share"
				lang="<?php echo $this->options['twitter_language']; ?>"
				data-url="<?php echo site_url(); ?>"
				data-text="<?php _e('I use WordPress Social Ring on my blog', WP_SOCIAL_RING); ?>"
				data-via="dottorwordpress" data-count="horizontal"
				class="sr-twitter-button twitter-share-button"></a>
		</div>
	</li>
	<li style="clear: both; padding-top: 10px;">
		<div style="float: left;">
			<input id='social_google_button'
				name='wp_social_ring_options[social_google_button]' type='checkbox'
				value="1"
				<?php checked($this->options['social_google_button'], 1); ?> />
		</div>
		<div style="float: left; margin-left: 20px; width: 150px;">
		<?php _e('Google +1',WP_SOCIAL_RING) ?>
		</div>
		<div style="float: left; margin-left: 20px;">
			<g:plusone
				href="<?php _e('http://wordpress.altervista.org/', WP_SOCIAL_RING); ?>"
				size="medium" callback="plusone_vote"></g:plusone>
	...
	<li style="clear: both; padding-top: 10px;">
		<div style="float: left;">
			<input id='social_linkedin_button'
				name='wp_social_ring_options[social_linkedin_button]'
				type='checkbox' value="1"
				<?php checked($this->options['social_linkedin_button'], 1); ?> />
		</div>
		<div style="float: left; margin-left: 20px; width: 150px;">
		<?php _e('LinkedIn',WP_SOCIAL_RING) ?>
		</div>
		<div style="float: left; margin-left: 20px;">
			<div class="social-ring-button">
				<script type="IN/Share" data-url="http://wordpress.altervista.org/"
	...
	<li style="clear: both; padding-top: 10px;">
		<div style="float: left;">
			<input id='social_pin_it_button'
				name='wp_social_ring_options[social_pin_it_button]' type='checkbox'
				value="1"
				<?php checked($this->options['social_pin_it_button'], 1); ?> />
		</div>
		<div style="float: left; margin-left: 20px; width: 150px;">
		<?php _e('Pin it',WP_SOCIAL_RING) ?>
		</div>
		<div style="float: left; margin-left: 20px;">
			<a
				href="http://pinterest.com/pin/create/button/?url=<?php echo urlencode(__('http://wordpress.altervista.org/', WP_SOCIAL_RING)); ?>&media=<?php echo urlencode('http://wordpress.altervista.org/logo.jpg'); ?>&description=<?php echo urlencode(__('WordPress tutorials, plugin and themes.', WP_SOCIAL_RING)." ".site_url()); ?>"
				class="pin-it-button" count-layout="horizontal"></a>
		</div>
	</li>
	<li style="clear: both; padding-top: 10px;">
		<div style="float: left;">
			<input id='social_stumble_button'
				name='wp_social_ring_options[social_stumble_button]' type='checkbox'
				value="1"
				<?php checked($this->options['social_stumble_button'], 1); ?> />
		</div>
		<div style="float: left; margin-left: 20px; width: 150px;">
		<?php _e('StumbleUpon',WP_SOCIAL_RING) ?>
		</div>
		<div style="float: left; margin-left: 20px;">
		...
		<?php
			...
			function show_on_setting() {
				?>
<ul>
	<li><span><input id='social_on_home'
			name='wp_social_ring_options[social_on_home]' type='checkbox'
			value="1" <?php checked($this->options['social_on_home'], 1); ?> /> </span>
		<span><?php _e('Home',WP_SOCIAL_RING) ?> </span>
	</li>
	<li><span><input id='social_on_pages'
			name='wp_social_ring_options[social_on_pages]' type='checkbox'
			value="1" <?php checked($this->options['social_on_pages'], 1); ?> />
	</span> <span><?php _e('Pages',WP_SOCIAL_RING) ?> </span>
	</li>
	<li><span><input id='social_on_posts'
			name='wp_social_ring_options[social_on_posts]' type='checkbox'
			value="1" <?php checked($this->options['social_on_posts'], 1); ?> />
	</span> <span><?php _e('Posts',WP_SOCIAL_RING) ?> </span>
	</li>
	<li><span><input id='social_on_category'
			name='wp_social_ring_options[social_on_category]' type='checkbox'
			value="1" <?php checked($this->options['social_on_category'], 1); ?> />
	</span> <span><?php _e('Categories',WP_SOCIAL_RING) ?> </span>
	</li>
	<li><span><input id='social_on_archive'
			name='wp_social_ring_options[social_on_archive]' type='checkbox'
			value="1" <?php checked($this->options['social_on_archive'], 1); ?> />
	</span> <span><?php _e('Archive',WP_SOCIAL_RING) ?> </span>
	</li>
</ul>
				<?php
			}
...
<?php foreach ($this->languages as $lang => $codes) { ?>
	...
	<?php selected($this->options['language'], $lang); ?>>
		<?php echo $lang; ?>
	</option>
	<?php } ?>
</select>
