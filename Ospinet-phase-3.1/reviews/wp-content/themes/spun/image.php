...
<div id="primary"
	class="content-area image-attachment">
	<div id="content" class="site-content" role="main">

	<?php while ( have_posts() ) : the_post(); ?>

		<nav id="image-navigation" class="site-navigation"> <span
			class="previous-image nav-previous"><?php previous_image_link( false, __( '<span class="meta-nav">&laquo;</span>', 'spun' ) ); ?>
		</span> <span class="next-image nav-next"><?php next_image_link( false, __( '<span class="meta-nav">&raquo;</span>', 'spun' ) ); ?>
		</span> </nav>
		<!-- #image-navigation -->

		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>> <header
			class="entry-header">
