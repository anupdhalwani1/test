...
</a> </span> <?php endif; ?> <span class="post-date"> <a
	href="<?php the_permalink(); ?>"
	title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'spun' ), the_title_attribute( 'echo=0' ) ) ); ?>"><?php the_date( get_option( 'date_format' ) ); ?>
</a> <?php _e( '@', 'spun' ); ?> <?php the_time( 'g:i a' ) ?> </span> <?php edit_post_link( __( 'Edit', 'spun' ), '<span class="edit-link">', '</span>' ); ?>
