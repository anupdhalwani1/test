...
function register_and_build_fields() {
	...
	add_settings_field('gridly_facebook_link', 'Facebook Link:', 'facebook_link_setting', __FILE__, 'main_section');
	add_settings_field('gridly_twitter_link', 'Twitter Link:', 'twitter_link_setting', __FILE__, 'main_section');
	add_settings_field('gridly_rss_link', 'RSS link:', 'rss_link_setting', __FILE__, 'main_section');
	add_settings_field('gridly_contact_link', 'Contact Link:', 'contact_link_setting', __FILE__, 'main_section');
...
<div id="theme-options-wrap" class="widefat">
	...
	<p>Take control of your theme, by overriding the default settings with
		your own specific preferences.</p>
...
function facebook_link_setting() {
	...
	echo "<input name='plugin_options[gridly_facebook_link]' type='text' value='{$options['gridly_facebook_link']}' />";
}

function twitter_link_setting() {
	$options = get_option('plugin_options');
	echo "<input name='plugin_options[gridly_twitter_link]' type='text' value='{$options['gridly_twitter_link']}' />";
}

function rss_link_setting() {
	$options = get_option('plugin_options');
	echo "<input name='plugin_options[gridly_rss_link]' type='text' value='{$options['gridly_rss_link']}' />";
}

function contact_link_setting() {
	$options = get_option('plugin_options');
	echo "<input name='plugin_options[gridly_contact_link]' type='text' value='{$options['gridly_contact_link']}' />";
}
