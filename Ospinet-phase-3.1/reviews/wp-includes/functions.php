...
<body>
	<h1>
	<?php _e( 'Error establishing a database connection' ); ?>
	</h1>
</body>
</html>
	<?php
...
<div id="wp-auth-check-wrap" class="<?php echo $wrap_class; ?>">
	...
	<div id="wp-auth-check">
		<div class="wp-auth-check-close" tabindex="0"
			title="<?php esc_attr_e('Close'); ?>"></div>
			<?php
		...
		<div class="wp-auth-fallback">
			<p>
				<b class="wp-auth-fallback-expired" tabindex="0"><?php _e('Session expired'); ?>
				</b>
			</p>
			<p>
				<a href="<?php echo esc_url( $login_url ); ?>" target="_blank"><?php _e('Please log in again.'); ?>
				</a>
