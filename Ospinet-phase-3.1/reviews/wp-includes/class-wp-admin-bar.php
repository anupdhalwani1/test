...
<div id="wpadminbar" class="<?php echo $class; ?>" role="navigation">
	<a class="screen-reader-shortcut" href="#wp-toolbar" tabindex="1"><?php _e('Skip to toolbar'); ?>
	</a>
	<div class="quicklinks" id="wp-toolbar" role="navigation"
		aria-label="<?php esc_attr_e('Top navigation toolbar.'); ?>"
		tabindex="0">
	...
	<a class="screen-reader-shortcut"
		href="<?php echo esc_url( wp_logout_url() ); ?>"><?php _e('Log Out'); ?>
	</a>
	<?php endif; ?>
</div>
	...
	final protected function _render_container( $node ) {
		...
		?>
<div id="<?php echo esc_attr( 'wp-admin-bar-' . $node->id ); ?>"
	...
	final protected function _render_group( $node ) {
		...
		?>
<ul id="<?php echo esc_attr( 'wp-admin-bar-' . $node->id ); ?>"
<?php echo $class; ?>>
	<?php
...
<li id="<?php echo esc_attr( 'wp-admin-bar-' . $node->id ); ?>"
		<?php echo $menuclass; ?>><?php
if ( $has_link ):
?><a class="ab-item" <?php echo $aria_attributes; ?>
	href="<?php echo esc_url( $node->href ) ?>"
	<?php
