...
echo '</div>';
	...
	<label class="screen-reader-text"
		for="cb-select-<?php echo $comment->comment_ID; ?>"><?php _e( 'Select comment' ); ?>
	</label> <input id="cb-select-<?php echo $comment->comment_ID; ?>"
	...
	<div id="inline-<?php echo $comment->comment_ID; ?>" class="hidden">
		...
		<?php echo esc_textarea( apply_filters( 'comment_edit_pre', $comment->comment_content ) ); ?>
		</textarea>
		<div class="author-email">
		<?php echo esc_attr( $comment->comment_author_email ); ?>
		</div>
		<div class="author">
		<?php echo esc_attr( $comment->comment_author ); ?>
		</div>
		<div class="author-url">
		<?php echo esc_attr( $comment->comment_author_url ); ?>
		</div>
...
class WP_Post_Comments_List_Table extends WP_Comments_List_Table {
	...
	<table
		...
		<?php if ( $singular ) echo " data-wp-lists='list:$singular'"; ?>>
