...
<div id="screen-meta" class="metabox-prefs">
	...
	<div id="contextual-help-wrap"
		class="<?php echo esc_attr( $help_class ); ?>" tabindex="-1"
			...
			<div class="contextual-help-tabs">
				...
				?>
					...
					<li id="<?php echo esc_attr( $link_id ); ?>" <?php echo $class; ?>>
						...
						aria-controls="<?php echo esc_attr( $panel_id ); ?>"> <?php echo esc_html( $tab['title'] ); ?>
					</a>
					</li>
					<?php
					$class = '';
...
<?php if ( $this->get_help_tabs() ) : ?>
	<div id="contextual-help-link-wrap"
		...
		<a href="#contextual-help-wrap" id="contextual-help-link"
			class="show-settings" aria-controls="contextual-help-wrap"
			aria-expanded="false"><?php _e( 'Help' ); ?> </a>
	</div>
	<?php endif;
	if ( $this->show_screen_options() ) : ?>
	<div id="screen-options-link-wrap"
		...
		<a href="#screen-options-wrap" id="show-settings-link"
			class="show-settings" aria-controls="screen-options-wrap"
			aria-expanded="false"><?php _e( 'Screen Options' ); ?> </a>
	</div>
	<?php endif; ?>
</div>
	<?php
...
<div id="screen-options-wrap" class="hidden" tabindex="-1"
	...
	function render_screen_layout() {
		...
		?>
<h5 class="screen-layout">
<?php _e('Screen Layout'); ?>
</h5>
...
for ( $i = 1; $i <= $num; ++$i ):
?>
	<label class="columns-prefs-<?php echo $i; ?>"> <input type='radio'
		name='screen_columns' value='<?php echo esc_attr( $i ); ?>'
		<?php checked( $screen_layout_columns, $i ); ?> /> <?php echo esc_html( $i ); ?>
	</label>
	<?php
	endfor; ?>
</div>
...
<?php if ( $per_page_label ) : ?>
	<input type="number" step="1" min="1" max="999" class="screen-per-page"
		...
		value="<?php echo esc_attr( $per_page ); ?>" /> <label
		for="<?php echo esc_attr( $option ); ?>"> <?php echo esc_html( $per_page_label ); ?>
	</label>
	<?php endif;
