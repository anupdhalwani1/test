...
<?php screen_icon('ms-admin'); ?>
	...
	<h3 id="add-existing-user">
	<?php _e( 'Add Existing User' ); ?>
	</h3>
	<form action="site-users.php?action=adduser" id="adduser" method="post">
		...
		<table class="form-table">
			<tr>
				...
				<td><input type="text" class="regular-text wp-suggest-user"
					name="newuser" id="newuser" /></td>
			</tr>
			<tr>
	...
	<form
		action="<?php echo network_admin_url('site-users.php?action=newuser'); ?>"
		...
		<table class="form-table">
			...
			<tr class="form-field">
				<td colspan="2"><?php _e( 'Username and password will be mailed to the above email address.' ) ?>
				</td>
			</tr>
		</table>
