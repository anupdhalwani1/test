...
<?php screen_icon(); ?>
	...
	<div class="editwidget" <?php echo $width; ?>>
		...
		<form action="widgets.php" method="post">
			...
			<p class="describe">
			<?php _e('Select both the sidebar for this widget and the position of the widget in that sidebar.'); ?>
			</p>
			...
			submit_button( __( 'Save Widget' ), 'button-primary alignright', 'savewidget', false ); ?>
				<input type="hidden" name="widget-id" class="widget-id"
					value="<?php echo esc_attr($widget_id); ?>" /> <input type="hidden"
					name="id_base" class="id_base"
					value="<?php echo esc_attr($id_base); ?>" /> <input type="hidden"
					name="multi_number" class="multi_number"
...
<?php screen_icon(); ?>
	...
	<div id="message" class="updated">
		<p>
		<?php echo $messages[$_GET['message']]; ?>
		</p>
	</div>
	<?php } ?>
			...
			<div id="available-widgets" class="widgets-holder-wrap">
				<div class="sidebar-name">
					...
					<?php _e('Available Widgets'); ?>
						<span id="removing-widget"><?php _ex('Deactivate', 'removing-widget'); ?>
							<span></span> </span>
					</h3>
				</div>
