...
<fieldset>
	<legend class="screen-reader-text">
		<span><?php _e('Admin Color Scheme')?> </span>
	</legend>
	<?php
	...
	<div class="color-option">
		<input name="admin_color"
			...
			value="<?php echo esc_attr( $color ); ?>" class="tog"
			<?php checked($color, $current_color); ?> />
		...
		<label for="admin_color_<?php echo esc_attr( $color ); ?>"><?php echo esc_html( $color_info->name ); ?>
		</label>
	</div>
	<?php endforeach; ?>
</fieldset>
...
function _ipad_meta() {
	if ( wp_is_mobile() ) {
		?>
<meta
	name="viewport" id="viewport-meta"
