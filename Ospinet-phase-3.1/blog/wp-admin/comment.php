	...
	<?php screen_icon(); ?>
		...
		<table class="form-table comment-ays">
			...
			<tr>
				...
				<td><a href="<?php echo $comment->comment_author_url; ?>"><?php echo $comment->comment_author_url; ?>
				</a></td>
			</tr>
			<?php } ?>
			<tr>
				<th scope="row" valign="top"><?php /* translators: field name in comment form */ _ex('Comment', 'noun'); ?>
				</th>
		...
		<p>
		<?php _e('Are you sure you want to do this?'); ?>
		</p>
		...
		<form action='comment.php' method='get'>
			...
			<table width="100%">
				<tr>
					<td><a class="button"
						href="<?php echo admin_url('edit-comments.php'); ?>"><?php esc_attr_e('No'); ?>
					</a></td>
					<td class="textright"><?php submit_button( $button, 'button' ); ?>
					</td>
				</tr>
			</table>
			...
			<input type='hidden' name='action'
				value='<?php echo esc_attr($formaction); ?>' /> <input type='hidden'
				name='c' value='<?php echo esc_attr($comment->comment_ID); ?>' /> <input
