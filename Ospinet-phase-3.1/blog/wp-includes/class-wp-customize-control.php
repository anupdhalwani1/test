...
<li id="<?php echo esc_attr( $id ); ?>"
	class="<?php echo esc_attr( $class ); ?>"><?php $this->render_content(); ?>
</li>
		<?php
	}
...
<label> <input type="checkbox"
	value="<?php echo esc_attr( $this->value() ); ?>"
	<?php $this->link(); checked( $this->value() ); ?> /> <?php echo esc_html( $this->label ); ?>
</label>
	<?php
	break;
case 'radio':
...
<span class="customize-control-title"><?php echo esc_html( $this->label ); ?>
	...
	?>
<label> <input type="radio" value="<?php echo esc_attr( $value ); ?>"
	name="<?php echo esc_attr( $name ); ?>"
	<?php $this->link(); checked( $this->value(), $value ); ?> /> <?php echo esc_html( $label ); ?><br />
</label>
	<?php
	endforeach;
	break;
...
<div class="customize-image-picker">
	...
	<div class="library">
		...
		<div class="library-content"
			data-customize-tab='<?php echo esc_attr( $id ); ?>'>
...
<a href="#" class="thumbnail"
	data-customize-image-value="<?php echo esc_url( $url ); ?>"> <img
	src="<?php echo esc_url( $thumbnail_url ); ?>" /> </a>
		<?php
	}
}
...
<a href="#" class="thumbnail"
	...
	<img src="<?php echo esc_url( $header['thumbnail_url'] ); ?>" /> </a>
		<?php
	}
