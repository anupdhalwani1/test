	...
	<form action="<?php echo site_url(); ?>/wp-comments-post.php"
		...
		<?php printf(__('Logged in as <a href="%1$s">%2$s</a>.'), get_edit_user_link(), $user_identity); ?>
			<a href="<?php echo wp_logout_url(get_permalink()); ?>"
				title="<?php esc_attr_e('Log out of this account'); ?>"><?php _e('Log out &raquo;'); ?>
			</a>
		</p>
		...
		<p>
			<input type="text" name="author" id="author"
				...
				tabindex="1" <?php if ($req) echo "aria-required='true'"; ?> /> <label
				for="author"><small><?php _e('Name'); ?> <?php if ($req) _e('(required)'); ?>
			</small> </label>
		</p>
		...
		<p>
			<input type="text" name="email" id="email"
				...
				for="email"><small><?php _e('Mail (will not be published)'); ?> <?php if ($req) _e('(required)'); ?>
			</small> </label>
		</p>
		...
		<p>
			<input type="text" name="url" id="url"
				...
				tabindex="3" /> <label for="url"><small><?php _e('Website'); ?> </small>
			</label>
		</p>
