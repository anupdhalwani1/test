...
<div id="primary" class="site-content">
	...
	<?php while ( have_posts() ) : the_post(); ?>
		...
		<?php post_class( 'image-attachment' ); ?>> <header
			class="entry-header">
		...
		</footer><!-- .entry-meta --> <nav id="image-navigation"
			class="navigation" role="navigation"> <span class="previous-image"><?php previous_image_link( false, __( '&larr; Previous', 'twentytwelve' ) ); ?>
		</span> <span class="next-image"><?php next_image_link( false, __( 'Next &rarr;', 'twentytwelve' ) ); ?>
		</span> </nav><!-- #image-navigation --> </header><!-- .entry-header -->
