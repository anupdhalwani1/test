...
<script type="text/javascript">
	 $(document).ready(function(e) {
		 ...
		 function resend_password(email)
			{
				$.ajax({//4
						url:" <?php echo base_url().'register/forgotpassword_mailsent'; ?>",
						type: 'POST',
						async : false,
						data: {"email":email},
			...
			$.validator.addMethod("pwdreg", function(value, element) {
			 ...
			 $("#resetpwdfrm").validate(
			 {
					 ...
					 rules: {
					  ...
					  rpwd: {required:"Please enter a Re-enter address",equalTo:"Password and Re-Password is not match"}
					  },
					  submitHandler: function(form) 
					  {
						   $.post("<?php echo base_url().'register/update_password'; ?>", //post
								   $("#resetpwdfrm").serialize(),
								   function(data)
								   {
									    if(data=="success")
													...
													<form id="resetpwdfrm" method="POST">
														...
														<div class="form-group">
															...
															<input type="text" name="oldpwd" class="form-control"
																id="oldpwd" placeholder="Current Password">
														</div>
														<div class="form-group">
